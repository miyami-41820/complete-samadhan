...
export const getServicesAdmin = async(req, res) => {
    try {
        const services = await Service.find({}).populate('userId').populate('serviceId').populate('orderId');
...
export const getServicesUser = async(req, res) => {
    ...
    console.log(userId)
    try {
        const services = await Service.find({ userId: userId }).populate('userId').populate('serviceId').populate('orderId');
